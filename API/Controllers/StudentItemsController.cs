...
namespace API.Controllers
{
    ...
    public class StudentItemsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<StudentItem>>> GetTodoItems()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<StudentItem>> GetTodoItem(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTodoItem(long id, StudentItem todoItem)
        {
            if (id != todoItem.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<StudentItem>> PostTodoItem(StudentItem todoItem)
        {
